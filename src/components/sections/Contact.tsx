...
export function Contact() {
    ...
    const handleSubmit = async (values: ContactFormValues) => {
        ...
        try {
            ...
            message.error('Failed to send email. Please try again or contact us directly.');
        } finally {
            setLoading(false);
        }
    };
                        ...
                        <AnimatedSection delay={0.35} direction="left">
                            <div className="p-5 rounded-2xl border border-blue-500/20 bg-blue-500/8">
                                ...
                                <div
                                    ...
                                    dangerouslySetInnerHTML={{ __html: t('contact.fastResponse.text') }}
                                />
                            </div>
                        </AnimatedSection>
                    </div>
